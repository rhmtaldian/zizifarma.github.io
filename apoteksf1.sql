...
--
-- Inang: 127.0.0.1
-- Waktu pembuatan: 14 Mei 2019 pada 16.21
-- Versi Server: 5.5.32
-- Versi PHP: 5.4.19
...
--
-- Basis data: `apoteksf1`
--
CREATE DATABASE IF NOT EXISTS `apoteksf1` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `apoteksf1`;
...
CREATE TABLE IF NOT EXISTS `transaksi` (
  ...
  KEY `id_barang` (`id_barang`,`id_pasien`),
  KEY `id_pasien` (`id_pasien`)
